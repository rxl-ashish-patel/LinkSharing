...
//    static allowedMethods = [save: "POST", update: "PUT", delete: "DELETE"]
    ...
    def index() {
        if (session?.currentUser) {
            ...
            render view: '/user/index', model: [recentShares: resourceService.recentShare(2), topPosts: resourceService.topPosts(5)]
        }
    ...
    def showUserProfile(){
        ...
        if(profileUser.id==session.currentUser.id || profileUser.admin){
