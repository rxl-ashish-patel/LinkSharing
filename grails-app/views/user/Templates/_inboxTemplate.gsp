        ...
        <div class="row  align-items-center">
            ...
            <div class="col-sm-9 ">
                <div class="card-block d-flex justify-content-between">
                    ...
                    <a href="${createLink(controller: 'topic', action: 'show', params: [topic: resourc.topic.id,isSuscribed:((resourc.topic.subscriptions*.user).find{it==user})])}"><strong>${resourc.topic.name}</strong>
                    </a>
                </div>
